    ...
    return (
      <PlateElement className={cn(className, "my-2")} ref={ref} {...props}>
        <ColumnFloatingToolbar>
          <div className={cn("size-full flex gap-4 rounded")}>{children}</div>
        </ColumnFloatingToolbar>
      </PlateElement>
    );
  },
  ...
  return (
    <Popover modal={false} open={isOpen}>
      ...
      <PopoverContent
        ...
        sideOffset={10}
      >
        <div className="[&_svg]:size-4 box-content flex h-9 items-center gap-1 [&_svg]:text-muted-foreground">
